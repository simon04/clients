...
import { BrowserStateServiceImpl } from "./browser-state.service.impl";
...
describe("Browser State Service", () => {
  ...
  let stateMigrationService: SubstituteOf<StateMigrationServiceImpl>;
  ...
  let sut: BrowserStateServiceImpl;
  ...
  describe("direct memory storage access", () => {
    ...
    beforeEach(() => {
      ...
      sut = new BrowserStateServiceImpl(
        diskStorageService,
