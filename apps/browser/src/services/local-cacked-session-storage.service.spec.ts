...
import { KeyGenerationServiceImpl } from "./key-generation.service.impl";
...
describe("Browser Session Storage Service", () => {
  let encryptService: SubstituteOf<EncryptServiceImpl>;
  let keyGenerationService: SubstituteOf<KeyGenerationServiceImpl>;
