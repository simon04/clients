...
describe("PSONO JSON Importer", () => {
  ...
  it("should parse TOTP", async () => {
    ...
    //totp_period
    expect(cipher.fields[0].name).toEqual("totp_period");
    expect(cipher.fields[0].value).toEqual("30");
    expect(cipher.fields[0].type).toEqual(FieldType.Text);
    //totp_algorithm
    expect(cipher.fields[1].name).toEqual("totp_algorithm");
    expect(cipher.fields[1].value).toEqual("SHA1");
    expect(cipher.fields[1].type).toEqual(FieldType.Text);
    //totp_digits
    expect(cipher.fields[2].name).toEqual("totp_digits");
    expect(cipher.fields[2].value).toEqual("6");
    expect(cipher.fields[2].type).toEqual(FieldType.Text);
    //create_data
    expect(cipher.fields[3].name).toEqual("create_date");
    expect(cipher.fields[3].value).toEqual("2022-12-13T19:41:42.972586Z");
    expect(cipher.fields[3].type).toEqual(FieldType.Text);
    //write_data
    expect(cipher.fields[3].name).toEqual("write_date");
    expect(cipher.fields[3].value).toEqual("2022-12-13T19:41:42.972609Z");
    expect(cipher.fields[3].type).toEqual(FieldType.Text);
  });
  ...
  it("should parse GPG data", async () => {
    ...
    //Keyname
    expect(cipher.fields[0].name).toEqual("mail_gpg_own_key_name");
    expect(cipher.fields[0].value).toEqual("My key name");
    expect(cipher.fields[0].type).toEqual(FieldType.Text);
    //Email
    expect(cipher.fields[1].name).toEqual("mail_gpg_own_key_email");
    expect(cipher.fields[1].value).toEqual("some@email.com");
    expect(cipher.fields[1].type).toEqual(FieldType.Text);
    // Private Key
    expect(cipher.fields[2].name).toEqual("mail_gpg_own_key_private");
    expect(cipher.fields[2].value).toEqual(
    ...
    expect(cipher.fields[2].type).toEqual(FieldType.Hidden);
  });
  ...
  it("should parse Environment variables data", async () => {
    ...
    //Keyname
    expect(cipher.fields[0].name).toEqual("Key1");
    expect(cipher.fields[0].value).toEqual("Value1");
    expect(cipher.fields[0].type).toEqual(FieldType.Text);
    //Email
    expect(cipher.fields[1].name).toEqual("Key2");
    expect(cipher.fields[1].value).toEqual("Value2");
    expect(cipher.fields[1].type).toEqual(FieldType.Text);
  });
